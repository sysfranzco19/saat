...
<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo base_url();?>/assets/media/error/bg5.jpg);">
				<!--begin::Content-->
				<div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
					<h1 class="error-title font-weight-boldest text-info mt-10 mt-md-0 mb-12">Oops!</h1>
					<p class="font-weight-boldest display-4">Inscripción bloqueada.</p>
					<p class="font-size-h3">IdAlumno: <?php echo $student_id; ?> - Estudiante: <?php echo $student; ?></p>
					<p class="font-size-h3">Por favor comuníquese con Administración (administracion@tiquipaya.edu.bo).</p>
