                    ...
                    <div class="login-form login-signin">
                        ...
                        <form method="post" role="form" id="form_login" action="<?php echo base_url('/login'); ?>"
                            ...
                            <div class="pb-13 pt-lg-0 pt-5">
                                ...
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Bienvenido a
                                    <?php echo $system_title; ?>
                                </h3>

                                <span class="text-muted font-weight-bold font-size-h4">Eres Nuevo?

                                    <a href="<?php echo base_url(); ?>index.php/login/create_account"
                                        id="kt_login_signup"
                                        class="text-primary font-weight-bolder">Registrarse</a></span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text"
                                    name="email" id="email" autocomplete="off" tabindex="1" autofocus />
