...
<div class="sidebar sidebar-right d-flex flex-row-auto flex-column" id="kt_sidebar">
    ...
    <div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
                ...
                <div align="center">
                    <div class="symbol symbol-60 symbol-2by3 flex-shrink-0">
                        <div class="symbol-label"
                            style="background-image: url('assets/media/stock-600x400/logopngtiqui.png')"></div>
                    </div>

                    <div class="text-inverse-danger font-weight-bolder font-size-h2 mb-2 mt-5"> SAAT Colegio Tiquipaya
                    </div>
                    <div class="font-weight-bold text-inverse-danger font-size-sm">Sistema Administrativo Académico
                        Tiquipaya</div>
                </div>
            </div>
            <!--end::Body-->
        ...
        <!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/stats/widget-13","page":"index"}]/-->
        ...
        <div class="card card-custom card-shadowless bg-white gutter-b">
            ...
            <div class="card-body pt-8">
                ...
                <div class="d-flex align-items-center mb-10">
                    ...
                    <div class="d-flex flex-column font-weight-bold">
                        <?php
                        $curso_id = $session->get('section_id');
                        $nivel = 'prim';
                        $nivel_text = 'primaria';
                        /*
                        $consulta='SELECT section_id FROM student WHERE student_id='.$this->session->userdata('student_id');
                        $cursos = $this->db->query($consulta)->result_array();
                        foreach ($cursos as $curso){
                            $curso_id = $curso['section_id'];
                        }
                        */
                        if ($curso_id > 270) {
                            $nivel = "sec";
                            $nivel_text = 'secundaria';
                        }
                ...
                <div class="d-flex align-items-center mb-10">
                    ...
                    <!--begin::Text-->
                    <div class="d-flex flex-column font-weight-bold">
                        <a href="https://sites.google.com/tiquipaya.edu.bo/biblioteca-de-tutoriales/inicio"
                            target="_blank" class="text-dark text-hover-primary mb-1 font-size-lg">Tutoriales
                            Classroom</a>
                        <span class="text-muted">Biblioteca de Tutoriales Classroom</span>
                    </div>
