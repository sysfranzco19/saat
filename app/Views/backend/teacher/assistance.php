                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title <?php if ($c == 0) {
                            echo 'collapsed';
                        } ?> " data-toggle="collapse" data-target="#collapseOne<?php echo $paralelo['section_id'] ?>">
                            Paralelo
                            <?php echo $paralelo['nick_name']; ?>
                        </div>
                    </div>
                    <div id="collapseOne<?php echo $paralelo['section_id'] ?>" class="collapse <?php if ($c == 0) {
                           echo 'show';
                                ...
                                <tbody>
                                    ...
                                    foreach ($subjects as $subject) {
                                        if ($subject['section_id'] == $paralelo['section_id']) {
                                            $url = '';
                                            if ($subject['section_id'] < 231) {
                                                $url = 'attendance_inicial';
                                            } else {
                                                $url = 'attendance';
                                            }
                                            ?>
