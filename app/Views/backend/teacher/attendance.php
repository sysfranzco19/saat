    ...
    <div class="container-fluid">
        ...
        <div class="card card-custom gutter-b shadow-sm">
            ...
            <div class="card-body pt-4">
                ...
                <form action="<?= base_url() . '/teacher/attendance_date' ?>" method="POST" id="form_date_period" name="form_date">
                ...
                <?php if (isset($students) && isset($date_id)): ?>
                    <!-- Students List Table -->
                    <hr>
                    <form action="<?= base_url() . '/teacher/attendance_save' ?>" method="POST" id="form_assists" name="form_assists">
                        <input type="hidden" name="subject_id" value="<?= $subject_id ?>">
