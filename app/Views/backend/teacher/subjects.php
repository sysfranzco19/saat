...
function link_update($subject_id, $partial_locked, $locked, $official_id, $hours){
    $link_half = "";
    if ($partial_locked==1 && $locked==0 && $official_id==0 && $hours>=1) {
        $link_half = "<a href='".base_url()."teacher/half_phase/".$subject_id."' target='_blank' class='btn btn-secondary btn-sm' >Actualizar Notas</a>";
    }
    echo $link_half;
}
?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title <?php if ($c == 0) {
                            echo 'collapsed';
                        } ?> " data-toggle="collapse" data-target="#collapseOne1">Primaria 1ro - 2do </div>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($sub_prim12 as $subject) {
                                        ?>
                                        <tr>
                                            <th scope="row"><?php echo $subject['name']; ?> -
                                                <?php echo $subject['nick_name']; ?>
                                            </th>
                                            <td>
                                                <?php
            ...
            if (count($sub_prim36) > 0) {
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title <?php if ($c == 0) {
                            echo 'collapsed';
                        } ?> " data-toggle="collapse" data-target="#collapseOne2">Primaria 3ro - 6to </div>
                    </div>
            ...
            if (count($sub_sec13) > 0) {
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title <?php if ($c == 0) {
                            echo 'collapsed';
                        } ?> " data-toggle="collapse" data-target="#collapseOne3">Secundaria 1ro - 3ro </div>
                    </div>
            ...
            if (count($sub_sec46) > 0) {
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title <?php if ($c == 0) {
                            echo 'collapsed';
                        } ?> " data-toggle="collapse" data-target="#collapseOne4">Secundaria 4to - 6to </div>
                    </div>
