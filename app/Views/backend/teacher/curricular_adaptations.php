...
<div class="position-absolute bottom-0 left-0 right-0 d-none d-lg-flex flex-row-fluid">
    <span class="svg-icon svg-icon-full flex-row-fluid svg-icon-dark opacity-3">
        <!--begin::Svg Icon | path:/metronic/theme/html/demo10/dist/assets/media/bg/home-2-bg.svg-->
...
<path class="st0" d="M0,87c0,0,16-14,73-14s153,92,248,92S607,20,777,20s183,34,292,34s131-54,131-54v172H0V87z"></path>
    ...
    <div class="position-absolute d-flex top-0 right-0 offset-lg-5 col-lg-7 opacity-30 opacity-lg-100">
        <span class="svg-icon svg-icon-full flex-row-fluid p-10">
            <!--begin::Svg Icon | path:/metronic/theme/html/demo10/dist/assets/media/svg/illustrations/working.svg-->
    ...
    <div class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40">
        <!--begin::Heading-->
        <h2 class="text-dark font-weight-bolder mb-8">Adaptaciones Curriculares</h2>
        <h3 class="text-danger font-weight-bolder mb-8">Departamento Psicopedagógico</h3>
        <!--end::Heading-->
        <!--begin::Form-->
...
<div class="row mt-0 mt-lg-8">
            ...
            <div class="col-xl-12">
                ...
                <!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/charts/widget-5","page":"index"}]/-->

                <!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/charts/widget-5","page":"index"}]/-->
            </div>
    ...
    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Casos Atendidos DPP</h5>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="/metronic/demo10/.html" class=""></a>
                <!--end::Button-->
                <!--begin::Button-->
                            ...
                            <thead class="datatable-head">
                                <tr class="datatable-row" style="left: 0px;">
                                    <th data-field="OrderID"
                                        ...
                                        data-sort="asc"><span style="width: 250px;">Estudiante<i
                                                class="flaticon2-arrow-up"></i></span></th>
                                    <th data-field="Country" class="datatable-cell datatable-cell-sort"><span
                                            style="width: 80px;">Curso</span></th>
                                    <th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span
                                            style="width: 121px;">DIAGNÓSTICO</span></th>
                                    
                                    <th data-field="Status" class="datatable-cell datatable-cell-sort"><span
                                            style="width: 121px;">ADAPTACIONES</span></th>
                                    <th data-field="Actions" data-autohide-disabled="false"
                                        class="datatable-cell datatable-cell-sort"><span
                                            style="width: 180px;">OBSERVACIONES</span></th>
                                </tr>
                            </thead>
                            <tbody style="" class="datatable-body">
                                <?php
                                /*
                                $sql1 = "SELECT s.student_id, CONCAT(s.lastname, ' ', s.lastname2, ' ',s.name) AS nombre, c.nick_name, ad.diagnostico, ad.adaptaciones, ad.observaciones 
                                FROM curricular_adaptations as ad 
                                INNER JOIN student as s ON(ad.student_id=s.student_id)
                                INNER JOIN section as c ON(s.section_id=c.section_id)";
                                $students = $this->db->query($sql1)->result_array();
                                */
                                foreach($students as $row):
                                ?>
                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                    <td class="datatable-cell-sorted datatable-cell" data-field="OrderID"
                                        aria-label="0004-0800"><span style="width: 250px;">
                                            <div class="d-flex align-items-center">
                                                <!--
                                                <div class="symbol symbol-50 symbol-sm flex-shrink-0">
                                                    <div class="symbol-label"> <img class="h-100 align-self-end"
                                                            src="<?php //echo $this->crud_model->get_image_url('student',$row['student_id']);?>" class="rounded-circle" width="30" alt="photo">
                                                    </div>
                                                </div>
                                -->
                                                <img src="<?php //echo $this->crud_model->get_image_url('student',$row['student_id']);?>" class="rounded-circle" width="30" />
                                                <div class="ml-4">
                                    ...
                                    <td data-field="Country" aria-label="Philippines" class="datatable-cell"><span
                                            style="width: 80px;">
                                            <div class="font-weight-bolder font-size-lg mb-0"><?php echo $row['nick_name'];?></div>
                                            
                                        </span></td>
                                    <td data-field="ShipDate" aria-label="3/3/2017" class="datatable-cell"><span
                                            style="width: 121px;">
                                            <div class="font-weight-bolder text-primary mb-0"><?php echo $row['diagnostico'];?></div>
                                            
                                        </span></td>
                                    
                                    <td data-field="Status" aria-label="5" class="datatable-cell">
                                    <span style="overflow: visible; position: relative; width: 130px;">
                                        <?php echo $row['adaptaciones'];?>
                                        </span></td>
                                    </td>
                                    <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                        class="datatable-cell">
                                        <span style="overflow: visible; position: relative; width: 180px;">
