...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">Modificar Falta</h5>
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<i aria-hidden="true" class="ki ki-close"></i>
	</button>
</div>
<form action="<?php echo base_url().'teacher/infraction_updated'; ?>" method="post" class="form-horizontal" id="formEdit" >
<div class="modal-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-9">
            <select class="form-control" id="type_foul" name="type_foul" onChange="getCriteria(this.value);" required>
            </select>
        </div>
    </div>
    <div class="form-group row">
