...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel"><?php echo $system_title; ?> - Modificar Fecha</h5>
...
<div class="modal-footer">
	...
	<button type="submit" class="btn btn-secondary font-weight-bold">Guardar Cambios</button>
</div>
</form> 
<!--end::Modal-->