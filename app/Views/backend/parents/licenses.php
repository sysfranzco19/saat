...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
            ...
            <div class="alert-text">Las licencias para el día de hoy solo podrán registrarse hasta las
                <code>9:30 a.m.</code> y tendrán una duración máxima de 3 días.<br />
                Si necesita solicitar más días, por favor contacte a: <a class="font-weight-bold"
                    href="mailto:secretaria@tiquipaya.edu.bo" target="_blank">secretaria@tiquipaya.edu.bo</a>.<br />
                El envío de Licencias sólo esta habilitado para estudiantes de la Secundaria.
            </div>
        </div>
        <!--end::Notice-->
