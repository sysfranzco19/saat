            ...
            <div class="row justify-content-center py-8 px-8 py-md-36 px-md-0 bg-primary">
                <div class="col-md-9">
                    <div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">
                        ...
                        <h1 class="display-3 font-weight-boldest text-white order-1 order-md-2">HORARIO DE ENTREVISTAS
                        </h1>
                    </div>
                    ...
                    <div class="row pb-26">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    <th
                                        class="pt-1 pb-3 pl-0 font-weight-bolder text-muted font-size-lg text-uppercase">
                                        Nivel:</th>
                                    <th
                                        class="pt-1 pb-3 pr-0 font-weight-bolder text-muted font-size-lg text-uppercase text-right">
                                        Enlace:</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="border-top-0 pl-0 pt-3">Inicial (Kinder, 1° y 2°)</td>
                                    <td class="pr-0 pt-3 text-right">
                                        <a href="https://tiquipaya.edu.bo/ctdocs/horarioentrevistas/horario_entrevistas_ini.pdf" target="_blank" 
                                            class="btn btn-primary btn-sm">Ingresar</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-top-0 pl-0 pt-3">Primaria (3° a 6°)</td>
                                    <td class="pr-0 pt-3 text-right">
                                        <a href="https://tiquipaya.edu.bo/ctdocs/horarioentrevistas/horario_entrevistas_prim.pdf" target="_blank" 
                                            class="btn btn-primary btn-sm">Ingresar</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-top-0 pl-0 pt-3">Secundaria (1° a 6°)</td>
                                    <td class="pr-0 pt-3 text-right">
                                        <a href="https://tiquipaya.edu.bo/ctdocs/horarioentrevistas/horario_entrevistas_sec.pdf" target="_blank" 
                                            class="btn btn-primary btn-sm">Ingresar</a>
                                    </td>
                                </tr>
                            </tbody>
