...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">Realmente desea eliminar el Tipo de Dato Médico</h5>
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<i aria-hidden="true" class="ki ki-close"></i>
	</button>
</div>
<form action="<?php echo base_url().'manager/etipodatomedico_delete'; ?>" method="post" class="form" >
