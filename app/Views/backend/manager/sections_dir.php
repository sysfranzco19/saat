        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/low_averages/<?php echo $row['section_id']; ?>" class="btn btn-light-danger font-weight-bold mr-2" target="_blank">Promedios Bajos</a></td>
                    <td>
                    ...
                    <td><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/generate_ranking/<?php echo $row['section_id']; ?>" class="btn btn-light-warning font-weight-bold mr-2">Ranking</a></td>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
