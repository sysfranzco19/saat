        ...
        <div class=" d-flex flex-column align-items-center flex-column-auto py-9">
            ...
            <div class="btn p-0 symbol symbol-40 symbol-success" href="index.php">
                <div class="symbol-label">
                    <img alt="Logo" src="<?php echo base_url(); ?>assets/media/svg/avatars/007-boy-2.svg"
    ...
    <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pb-10">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body"
                ...
                <a href="<?php echo base_url(); ?>manager/assistance"
                    class="nav-link btn btn-icon btn-lg btn-borderless active">
                    <span class="svg-icon svg-icon-xxl">
            ...
            <li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body"
                ...
                <a href="<?php echo base_url(); ?>manager/behaviors"
                    class="nav-link btn btn-icon btn-lg btn-borderless active">
                    <span class="svg-icon svg-icon-xxl">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <path
                                    ...
                                    fill="#000000" />
                                <rect fill="#ffffff" opacity="0.3" x="10" y="9" width="7" height="2" rx="1" />
            ...
            <!--
                        <a href="<?php echo base_url(); ?>index.php/secretary/inbox" class="nav-link btn btn-icon btn-lg btn-borderless active"  data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="" data-original-title="Mensajes">
                            <span class="svg-icon svg-icon-xxl">
...
-->
            ...
            <!--begin::Item-->
            <li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body"
                data-boundary="window" title="Planificador de Evaluaciones">
                <a href="<?php echo base_url(); ?>manager/evaluation_planner"
                    class="nav-link btn btn-icon btn-lg btn-borderless active">
                    <span class="svg-icon svg-icon-xxl">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
    ...
    <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-8">
        <!--begin::Quick Panel-->
        <a href="<?php echo base_url(); ?>/logout" class="btn btn-icon btn-lg btn-borderless mb-1" id=""
