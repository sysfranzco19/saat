    ...
    function fillDelays(student_id){
        $.ajax({
			...
			success: function(response)
			{
                ...
                var elemento1 = document.getElementById("down_1er");
                var elemento2 = document.getElementById("down_2do");
                var elemento3 = document.getElementById("down_3er");
                var elemento4 = document.getElementById("down_all");
                elemento1.href = "<?php echo base_url(); ?>manager/delay_xlsx/" + student_id + "/1";
                elemento2.href = "<?php echo base_url(); ?>manager/delay_xlsx/" + student_id + "/2";
                elemento3.href = "<?php echo base_url(); ?>manager/delay_xlsx/" + student_id + "/3";
                elemento4.href = "<?php echo base_url(); ?>manager/delay_xlsx/" + student_id + "/0";
			},
		});
    }
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                        <a id="down_1er" class="dropdown-item" href="#" target="_blank" >1er TRIM</a>
                                        <a id="down_2do" class="dropdown-item" href="#" target="_blank" >2do TRIM</a>
                                        <a id="down_3er" class="dropdown-item" href="#" target="_blank" >3er TRIM</a>
                                        <a id="down_all" class="dropdown-item" href="#" target="_blank" >Todos</a>
                                    </div>
                                </div>
                            </div>
                        </div>
