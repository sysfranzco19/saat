...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">Eliminar el Registro de Enfermeria</h5>
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<i aria-hidden="true" class="ki ki-close"></i>
	</button>
</div>
<form action="<?php echo base_url().'manager/ehc_delete'; ?>" method="post" class="form" >
<div class="modal-body">
    ...
    <div class="form-group row">
    	...
    	<div class="col-9">
            <input type="time" class="form-control" value="" id="hora_ingreso" name="hora_ingreso" disabled >
        </div>
    </div>
    <div class="form-group row">
    	<label for="hora_salida" class="col-3 col-form-label">Hora de salida: </label>
    	<div class="col-9">
            <input type="time" class="form-control" value="" id="hora_salida" name="hora_salida" disabled >
        </div>
    </div>
    <div class="form-group row">
        <label for="sintoma" class="col-3 col-form-label">Síntoma: </label>
        <div class="col-9">
            <select class="custom-select" name="sintoma" id="sintoma" disabled >
                <option value=""> ------ </option>
            </select>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-9">
            <select class="custom-select" name="medicamento" id="medicamento" disabled >
                <option value=""> ------ </option>
            </select>
        </div>
    </div>
