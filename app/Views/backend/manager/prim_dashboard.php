...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-3 mb-4">
            <a href="<?= base_url('manager/prim_licencias') ?>" class="d-flex align-items-center bg-light-warning rounded p-5 h-100 text-decoration-none">
        ...
        <div class="col-md-3 mb-4">
            <a href="<?= base_url('manager/prim_licencias') ?>" class="d-flex align-items-center bg-light-danger rounded p-5 h-100 text-decoration-none">
        ...
        <div class="col-md-3 mb-4">
            <a href="<?= base_url('manager/prim_licencias') ?>" class="d-flex align-items-center bg-light-info rounded p-5 h-100 text-decoration-none">
        ...
        <div class="col-md-3 mb-4">
            <a href="<?= base_url('manager/prim_cambio_recojo') ?>" class="d-flex align-items-center rounded p-5 h-100 text-decoration-none" style="background:#FDEEE4;">
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <a href="<?= base_url('manager/prim_ausencias?todos=1') ?>" class="d-flex align-items-center bg-light-primary rounded p-5 h-100 text-decoration-none">
        ...
        <div class="col-md-6 mb-4">
            <a href="<?= base_url('manager/prim_ausencias') ?>" class="d-flex align-items-center bg-light-danger rounded p-5 h-100 text-decoration-none">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel-card">
                ...
                <div class="panel-footer">
                    <a href="<?= base_url('manager/prim_asistencia') ?>" style="color:#1d6ec9;">Ver Asistencia del Día →</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel-card">
                ...
                <div class="panel-footer">
                    <a href="<?= base_url('manager/prim_cambio_recojo') ?>" style="color:#c2600b;">Ver Cambio de Recojo →</a>
                </div>
            </div>
        </div>
