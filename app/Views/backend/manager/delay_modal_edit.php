<script type="text/javascript">
    function getDelay()
    {
        ...
        $.ajax({
			url: "<?php echo base_url(); ?>manager/delay_get/<?php echo $param1; ?>",
...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">Modificar Retraso</h5>
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<i aria-hidden="true" class="ki ki-close"></i>
	</button>
</div>
<form action="<?php echo base_url().'manager/delay_update'; ?>" method="post" class="form-horizontal" >
