        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label"> Ingreso de Datos
                    <span class="text-muted pt-2 font-size-sm d-block">Registro de Visitas</span></h3>
                </div>
                <div class="card-toolbar">
                    <button type="button" class="btn btn-light-success font-weight-bold mr-2" onclick="showAjaxModal('<?php echo base_url();?>/modal/popup/ehc_modal_add/0/0/0/0/0');" >
                        Nuevo Registro
                    </button>
                </div>
            </div>
                ...
                <table class="table table-bordered table-checkable" id="kt_datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btn-sm" onclick="showAjaxModal('<?php echo base_url();?>/modal/popup/ehc_modal_edit/<?php echo $key->id ?>/0/0/0/0');" >
                                    Editar
                                </button>
                                <button type="button" class="btn btn-danger btn-sm" onclick="showAjaxModal('<?php echo base_url();?>/modal/popup/ehc_modal_del/<?php echo $key->id ?>/0/0/0/0');" >
                                    Eliminar
                                </button>
                            </td>
                        </tr>
