...
<div class="row">
    ...
    <div class="col-xl-8">
        <form method="POST" action="<?= base_url('manager/prim_licencias_periodo_create') ?>" id="form_lic">
            <?= csrf_field() ?>
            ...
            <div class="card card-custom">
                ...
                <div class="card-footer d-flex align-items-center">
                    ...
                    <a href="<?= base_url('manager/prim_licencias') ?>" class="btn btn-secondary">Cancelar</a>
...
function cargarCupo(student_id) {
    $.post('<?= base_url('manager/prim_cupo_estudiante') ?>', {
...
document.getElementById('form_lic').addEventListener('submit', function(e) {
    ...
    $.post(form.action, $(form).serialize(), function(res) {
        ...
        if (r.ok) {
            window.location.href = '<?= base_url('manager/prim_licencias') ?>';
        } else {
