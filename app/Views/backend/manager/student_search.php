<script type="text/javascript">
    function cargar(){
        ...
        window.location.assign('<?php echo base_url(); ?>manager/student_search/<?php echo $user; ?>/' + sel )
        //alert('hola');
    }
</script>
<?php
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/notes_half_student/<?php echo $id;?>" target="_blank" >Medio Trimestre</a>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/student_notes/<?php echo $id;?>" target="_blank" >Nota Trimestral</a>
                                        <!-- 
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/report_card/<?php echo $id;?>" target="_blank" >Reporte Académico Trimestral</a>
                                         -->
                                    </div>
                                </div>
                                    <?php
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/student_attendance/<?php echo $id;?>" target="_blank">Asistencias</a>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/student_licenses/<?php echo $id;?>" target="_blank">Licencias</a>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/student_absences/<?php echo $id;?>" target="_blank">Ausencias</a>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/student_delays/<?php echo $id;?>" target="_blank">Retrasos</a>
                                    </div>
                                </div>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/student_infractions/<?php echo $id;?>"" target="_blank" >Faltas Leves</a>
                                        <!-- 
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/error" target="_blank" >Comunicación</a>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>manager/dashboard" target="_blank" >Entrevistas</a>
