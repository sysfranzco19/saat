        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <form action="<?= base_url('manager/profile_update') ?>" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
            ...
            <div class="col-lg-4">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <form action="<?= base_url('manager/password_update') ?>" method="POST" id="password_form">
                        <div class="card-body">
                            <div class="form-group">
