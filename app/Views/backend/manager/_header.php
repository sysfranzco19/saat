                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            ...
                            <a href="javascript:void(0);"
                                onclick="$('#modalCalendarioAcademico').modal('show');"
                                class="menu-link">
                        ...
                        ?>
                            <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                ...
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="menu-text">Supervición Estudiantil</span>
                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <span class="menu-text">Retrasos del día</span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="<?php echo base_url(); ?>manager/delays/0"
                                                            class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="menu-text">Registrar retrasos</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                            ...
                                            <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/ehc"
                                                ...
                                                <span class="menu-text">Ingreso de Datos</span>
                                            </a>
                                        </li>
                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                            aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/family_search/director/0"
                                                ...
                                                <span class="menu-text">Reporte de Visitas</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                            ...
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">Síntomas</span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                            <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                <ul class="menu-subnav">
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="<?php echo base_url(); ?>manager/esintoma"
                                                            class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="<?php echo base_url(); ?>manager/ecategoria"
                                                            class="menu-link">
                                                            <i class="menu-bullet menu-bullet-dot">
                                                                <span></span>
                                                            </i>
                                                            <span class="menu-text">Categorías de Síntomas</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                            aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/emedicamento" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        if ($session->get('level') == 3) {
                            ...
                            <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                aria-haspopup="true">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="menu-text">Dpto. Psicopedagógico</span>
                                    <span class="menu-desc"></span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                    <ul class="menu-subnav">
                                        ...
                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                            aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/family_search/director/0"
                                                class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                        ...
                                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                            aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/students_list" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#000000" fill-rule="nonzero" opacity="0.3" />
                                                            <path
                                                                d="M3.00065168,20.1992055 C3.38825852,15.4265159 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.727502227,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z"
                                                                fill="#000000" fill-rule="nonzero" />
                                                        </g>
                                                    </svg>
                                                </span>
                            ...
                            <!-- Dirección Técnica removido del menú — botones en dashboard -->
                            <li class="menu-item menu-item-submenu menu-item-rel d-none" data-menu-toggle="click"
                                aria-haspopup="true">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                    <ul class="menu-subnav">
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/student_search/director/0" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/class_dir" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"/>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/sections_dir" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"/>
                                        ...
                                        <li class="menu-item" aria-haspopup="true">
                                            <a href="<?php echo base_url(); ?>manager/teacher_notes" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"/>
...
<!--begin::Modal Calendario Académico-->
<div class="modal fade" id="modalCalendarioAcademico" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius:12px; overflow:hidden;">
            <div class="modal-header border-0 py-3 px-6" style="background:#f8f9fa">
                <h5 class="modal-title font-weight-bolder text-dark">
                    <i class="flaticon2-calendar-5 text-primary mr-2"></i>
            ...
            <div class="modal-body p-0">
                <div style="position:relative; width:100%; height:0; padding-top:77.2727%; overflow:hidden;">
                    <iframe loading="lazy"
                        style="position:absolute; width:100%; height:100%; top:0; left:0; border:none; padding:0; margin:0;"
                        src="https://www.canva.com/design/DAGiL1spl3c/UdaE9N1yMTHhYwxQnkrfNA/view?embed"
...
<!--end::Modal Calendario Académico-->
