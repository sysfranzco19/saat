	...
	<div class=" container-fluid ">
        ...
        <div class="d-flex flex-column flex-md-row">
            ...
            <div class="flex-md-row-auto w-md-275px w-xl-325px">
                ...
                <div class="card card-custom bg-success-o-30 gutter-b">
                    <!--begin::Body-->
                    <div class="card-body">
                        <!--begin::Wrapper-->
                        <div class="d-flex justify-content-between flex-column h-100">
                            ...
                            <div class="h-100">
                                ...
                                <div class="d-flex flex-column  flex-center">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="font-weight-bold text-dark-50 font-size-sm pb-7"><?php echo $phase_name; ?></div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="pt-1">
                                    ...
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <div class="symbol symbol-45 symbol-light mr-4">
                                            <span class="symbol-label">
                                                <span class="svg-icon svg-icon-2x svg-icon-dark-50"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a href="" target="_blank" class="btn btn-secondary font-weight-bolder font-size-sm py-3 px-14">Carpeta Pedagógica</a>
                                        </div>
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    ...
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <a href="" target="_blank" class="btn btn-secondary font-weight-bolder font-size-sm py-3 px-14" >Horarios</a>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
                    ...
                    <div class="card card-custom wave wave-animate-slow wave-primary mb-8 mb-lg-0">
			            <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                <div class="mr-6">
                                    <span class="svg-icon svg-icon-warning svg-icon-4x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"></rect>
                ...
                <div class="row">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">Documentos</span>
                                </h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                                                    ...
                                                    <tr>
                                                        <td class="pl-0 pt-0 py-5">
                                                            <div class="symbol symbol-45 symbol-light-success mr-2">
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-2x svg-icon-success"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24"></rect>
                                                                ...
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-2x svg-icon-success"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            ...
                                                                            <path d="M12,22 C6.4771525,22 2,17.5228475 2,12 C2,6.4771525 6.4771525,2 12,2 C17.5228475,2 22,6.4771525 22,12 C22,17.5228475 17.5228475,22 12,22 Z M12,20 C16.418278,20 20,16.418278 20,12 C20,7.581722 16.418278,4 12,4 C7.581722,4 4,7.581722 4,12 C4,16.418278 7.581722,20 12,20 Z" fill="#000000" opacity="0.3"></path>
                                                                        </g></svg><!--end::Svg Icon-->
                                                                    </span>
                                                                </span>
                                                            </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">configuraciones</span>
                                </h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                                                            ...
                                                            <div class="symbol symbol-45 symbol-light-success mr-2">
                                                                <span class="symbol-label">
                                                                    <span class="svg-icon svg-icon-2x svg-icon-success"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                            <rect x="0" y="0" width="24" height="24"></rect>
                                                                            <path d="M5,3 L6.70881221,3 C7.02603625,3 7.31775239,3.1513234 7.5,3.40778839 L8.54711109,4.87325489 C8.62711109,4.98525489 8.75622538,5.05 8.9,5.05 L14,5.05 C15.1045695,5.05 16,5.9454305 16,7.05 L16,15.8507011 C16,16.9552706 15.1045695,17.8507011 14,17.8507011 L5,17.8507011 C3.8954305,17.8507011 3,16.9552706 3,15.8507011 L3,5.05 C3,3.9454305 3.8954305,3.05 5,3 Z" fill="#000000"></path>
                                                                            <path d="M11,21 L11,18 L13,18 L13,21 L11,21 Z M15,21 L15,18 L17,18 L17,21 L15,21 Z M7,21 L7,18 L9,18 L9,21 L7,21 Z" fill="#000000" opacity="0.3"></path>
                                                                        </g></svg><!--end::Svg Icon-->
                                                                    </span>
                                                                </span>
                                                            </div>
