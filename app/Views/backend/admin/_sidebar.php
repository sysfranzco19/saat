...
<div class="sidebar sidebar-right d-flex flex-row-auto flex-column" id="kt_sidebar">
    ...
    <div class="sidebar-content flex-column-fluid pb-10 pt-9 px-5 px-lg-10">
        ...
        <a href="#" class="card card-custom bg-danger bg-hover-state-danger card-shadowless gutter-b">
            ...
            <!--begin::Body-->
            <div class="card-body">
                <div class="text-inverse-danger font-weight-bolder font-size-h2 mb-2 mt-5">Colegio Tiquipaya </div>
        ...
        <div class="card card-custom card-shadowless bg-white gutter-b">
            ...
            <div class="card-body pt-8">
                ...
                <div class="d-flex align-items-center mb-10">
                    ...
                    <!--begin::Text-->
                    <div class="d-flex flex-column font-weight-bold">
                        <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Foros y Debates</a>
                        <span class="text-muted">Espacio de discución</span>
                    </div>
                ...
                <div class="d-flex align-items-center mb-10">
                    ...
                    <!--begin::Text-->
                    <div class="d-flex flex-column font-weight-bold">
                        <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Bachilllerato</a>
                        <span class="text-muted">Tecnico Humanistico</span>
                    </div>
