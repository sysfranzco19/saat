        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="<?php echo base_url(); ?>admin/send_mail_smtp">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo base_url(); ?>admin/copiarTStudent">copiarTStudent</a>
                        </div>
                    </form>
            ...
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="<?php echo base_url(); ?>admin/send_mail_php">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Input</label>
                                <input type="email" class="form-control form-control-solid" name="correo" id="correo" value="franz.condori.calderon@gmail.com" placeholder="" />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="<?php echo base_url(); ?>admin/send_alerta3_php">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Input</label>
                                <input type="email" class="form-control form-control-solid" name="correo" id="correo" value="franz.condori.calderon@gmail.com" placeholder="" />
            ...
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="<?php echo base_url(); ?>admin/send_alerta4_php">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Input</label>
                                <input type="email" class="form-control form-control-solid" name="correo" id="correo" value="franz.condori.calderon@gmail.com" placeholder="" />
