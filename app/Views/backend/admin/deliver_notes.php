                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <?php if (!empty($docente)): ?> &emsp; Docente: <?php echo $docente; ?><?php endif; ?>
                            ...
                            <?php if (($login_type ?? '') !== 'admin'): ?>
                                ...
                                ?>
                            <?php else: ?>
                                <a href="<?php echo base_url(); ?>admin/delivery_notes" class="btn btn-light-primary font-weight-bold">&laquo; Volver al listado</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-body">
