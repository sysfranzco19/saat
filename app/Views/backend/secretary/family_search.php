<script type="text/javascript">
    function cargar(){
        ...
        if (sel.length >= 3) {
            ...
            window.location.assign('<?php echo base_url(); ?>secretary/family_search/<?php echo $user; ?>/' + sel )
                ...
                <table class="table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btn-sm" onclick="window.location.href = '<?php echo base_url(); ?>secretary/family_info/<?php echo $id;?>';" >Ver información</button>
                            </td>
                        </tr>
                    <?php
                    }
