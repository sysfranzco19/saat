                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                            ...
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo base_url(); ?>secretary/licenses_received"
                                                        ...
                                                        <span class="menu-text">Centro de Asistencias</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo base_url(); ?>secretary/licenses_received"
                                                        ...
                                                        <span class="menu-text">Asistencias del Día</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo base_url(); ?>secretary/licenses"
                                                        ...
                                                        <span class="menu-text">Asistencias por cursos</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo base_url(); ?>secretary/assistance"
                                                        ...
                                                        <span class="menu-text">Todas las Asistencias</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?php echo base_url(); ?>secretary/attendance_by_course"
                                                        class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">Asistencia Secundaria</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="<?php echo base_url("secretary/suspensions"); ?>"class="menu-link">
                                            <span class="svg-icon menu-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span class="menu-text">Suspensiones</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <!-- Panel General -->
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?= base_url('secretary/prim_dashboard') ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?= base_url('secretary/prim_asistencia') ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">Asistencia del Día</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?= base_url('secretary/prim_ausencias') ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    ...
                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                        ...
                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?= base_url('secretary/prim_licencias') ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">Ver / Autorizar / Registrar Licencias</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?= base_url('secretary/prim_cambio_recojo') ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                                        <span class="menu-text">Cambio de Recojo</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="<?= base_url('secretary/prim_ausencias?todos=1') ?>" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    ...
                                    <!-- Retrasos -->
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?= base_url('secretary/prim_retrasos') ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
                                                    <g fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
                                    ...
                                    <!-- Reportes -->
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="<?= base_url('secretary/prim_reportes') ?>" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
                                                    <g fill="none" fill-rule="evenodd">
                                                        <polygon points="0 0 24 0 24 24 0 24"/>
...
-->
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="<?php echo base_url(); ?>secretary/boletas" class="menu-link">
                                <span class="menu-text">Boletas</span>
                                <i class="menu-arrow"></i>
                            </a>
                        </li>
