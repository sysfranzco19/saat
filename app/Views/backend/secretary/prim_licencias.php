...
function liberarDoc(licId) {
    ...
    post(BASE + 'secretary/prim_licencias_waive_doc', { licencias_id: licId })
    .then(res => {
        if (res.ok) {
...
function cargar() {
    ...
    post(BASE + 'secretary/prim_licencias_data', {
...
document.getElementById('modalAccionConfirm').addEventListener('click', function() {
    ...
    const url = tipo === 1 ? BASE + 'secretary/prim_licencias_auth'
              : tipo === 2 ? BASE + 'secretary/prim_licencias_noauth'
              : BASE + 'secretary/prim_licencias_delete';
...
function nlCargarCupo(student_id) {
    post(BASE + 'secretary/prim_cupo_estudiante', { student_id: student_id }).then(nlMostrarCupo);
}
...
function nlSubmit() {
    ...
    if (_nlTipo === 'dia') {
        ...
        url = BASE + 'secretary/prim_licencias_create';
        payload = {
        ...
        url = BASE + 'secretary/prim_licencias_periodo_create';
        payload = {
            student_id:            student_id,
            medio:                 document.getElementById('nl_medio').value,
            fechaSolicita:         document.getElementById('nl_fechaSolicita').value,
