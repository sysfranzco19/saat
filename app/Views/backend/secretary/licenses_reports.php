    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Reporte de licencias por DIAS y HORAS</h3>
                    </div>
                    <!--begin::Form-->
                    <form method="POST" action="<?php echo base_url().$account_type.'/licenses_report_xlsx'; ?>" >
                        <div class="card-body">
                            <div class="form-group">
                                <label for="fechaReporte">Fecha del Reporte :
                                <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" value="<?php echo $fecha_actual;?>" id="fechaReporte" name="fechaReporte" required >
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Reporte de licencias por CURSO</h3>
                    </div>
                    <!--begin::Form-->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Reporte de Licencias Rango de Fechas</h3>
                    </div>
                    <!--begin::Form-->
                    <form method="POST" action="<?php echo base_url().$account_type.'/licenses_report_dates_xlsx'; ?>" >
                        <div class="card-body">
                            <div class="form-group row">
                                <label  class="col-3 col-form-label" for="fechaIni">Fecha Inicial :
                                <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Licencias por Estudiante</h3>
                    </div>
                    <!--begin::Form-->
                    <form method="POST" action="<?php echo base_url().$account_type.'/licenses_report_student_xlsx'; ?>" >
                        <div class="card-body">
                            <div class="form-group">
