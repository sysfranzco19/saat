...
<div class="container-fluid pb-8">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-6">
            <div class="card card-custom shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url('secretary/prim_reportes_xlsx') ?>">
                        <?= csrf_field() ?>
        ...
        <!-- Reporte 5: Bus Escolar -->
        <div class="col-md-6 mb-6">
            <div class="card card-custom shadow-sm h-100">
                <div class="card-header border-0 pt-5" style="border-left:4px solid #3699ff;">
                    <h5 class="card-label font-weight-bolder">
                        <i class="fas fa-bus text-primary mr-2"></i>Bus Escolar
                    </h5>
                </div>
                <div class="card-body">
                    <p class="text-muted font-size-sm mb-4">
                        Para una fecha puntual: licencias (día y período), ausencias sin licencia
                        y cambios de recojo — todo lo que el bus escolar necesita saber ese día.
                    </p>
                    <form method="POST" action="<?= base_url('secretary/prim_reporte_bus_xlsx') ?>">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <label class="font-weight-bold font-size-sm">Fecha</label>
                            <input type="date" name="fecha" class="form-control"
                                   value="<?= date('Y-m-d') ?>" min="<?= $phase_ini ?>" max="<?= $phase_fin ?>" required>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block mt-5 font-weight-bold">
                            <i class="fas fa-download mr-2"></i>Descargar Excel
                        </button>
