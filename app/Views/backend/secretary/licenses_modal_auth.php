...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">Realmente desea autorizar la Licencia</h5>
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<i aria-hidden="true" class="ki ki-close"></i>
	</button>
</div>
<form action="<?php echo base_url().'secretary/licenses_auth'; ?>" method="post" class="form" >
...
<div class="modal-footer">
	...
	<button type="submit" class="btn btn-primary font-weight-bold">Autorizar</button>
</div>
</form> 
<!--end::Modal-->