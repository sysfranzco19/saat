...
<div class="modal-header">
	<h5 class="modal-title" id="exampleModalLabel">Modificar Medio de comunicación</h5>
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<i aria-hidden="true" class="ki ki-close"></i>
	</button>
</div>
<form action="<?php echo base_url().'secretary/medio_update'; ?>" method="post" class="form" >
<div class="modal-body">
    ...
    <label for="medioComunicacion" class="col-3 col-form-label">Medio de Comunicación: </label>
    	<div class="col-9">
            ...
            <input type="text" class="form-control" id="medioComunicacion" name="medioComunicacion" placeholder="Medio de Comunicación" >
        </div>
    </div>
</div>
