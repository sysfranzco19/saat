                        ...
                        <div class="d-flex justify-content-between flex-column h-100">
                            ...
                            <div class="h-100">
                                ...
                                <div class="d-flex flex-column  flex-center">
                                    ...
                                    <!--begin::Title-->
                                    <a
                                        class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Colegio
                                        Tiquipaya</a>
                                    <!--end::Title-->
                                ...
                                <div class="pt-1">
                                    ...
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/licenses"
                                                class="btn btn-secondary font-weight-bolder font-size-sm py-3 px-14">Licencias</a>
                                        </div>
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <div class="symbol symbol-45 symbol-light mr-4">
                                            <span class="symbol-label">
                                                <span class="svg-icon svg-icon-2x svg-icon-dark-50"><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                        height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none"
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/licenses_received"
                                                class="btn btn-secondary font-weight-bolder font-size-sm py-3 px-14">Autorizar
                                                Licencias</a>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a href="https://view.genial.ly/63f57dd528ebd200187bd46b"
                                                class="btn btn-secondary font-weight-bolder font-size-sm py-3 px-14"
                                                target="_blank">Horario de Entrevistas</a>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/enrolled_students"
                                                class="btn btn-secondary font-weight-bolder font-size-sm py-3 px-14">Listado
                                                de estudiantes</a>
                                        </div>
                                        <!--end::Text-->
                                    </div>
            ...
            <div class="flex-md-row-fluid ml-md-6 ml-lg-8">
                <div class="card card-custom mb-12">
                    <div class="card card-custom wave wave-animate-slow wave-primary mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                <div class="mr-6">
                                    <span class="svg-icon svg-icon-warning svg-icon-4x"><svg
                                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card card-custom bgi-no-repeat card-stretch gutter-b bg-primary"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="font-weight-bold text-inverse-primary font-size-h2">
                        ...
                        <div class="col-xl-6">
                            <div class="card card-custom bgi-no-repeat card-stretch gutter-b bg-success"
                                                        ...
                                                        <tr>
                                                            <td class="pl-0 pt-0 py-5">
                                                                <div class="symbol symbol-45 symbol-light-success mr-2">
                                                                    <span class="symbol-label">
                                                                        <span
                                                                            class="svg-icon svg-icon-primary svg-icon-2x"><svg
                                                                                xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/enrolled_students"
                                                                    class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Kardex
                                                                    Estudiantes</a>
                                                                <span
                                                                    class="text-muted font-weight-bold d-block">Listado
                                                                    de alumnos</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/family_search/family"
                                                                    class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Kardex
                                                                    Familia</a>
                                                                <span
                                                                    class="text-muted font-weight-bold d-block">Información
                                                                    familiar</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/counselors"
                                                                    class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Consejeros</a>
                                                                <span
                                                                    class="text-muted font-weight-bold d-block">Gestión
                                                                    de consejeros</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                ...
                                                <table class="table table-borderless table-vertical-center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/infractions"
                                                                    class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Reportes
                                                                    Conductuales</a>
                                                                <span class="text-muted font-weight-bold d-block">Faltas
                                                                    leves</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="<?php echo base_url(); ?><?php echo $account_type; ?>/behaviors"
                                                                    ...
                                                                    de Maestros</a>
                                                                <span
                                                                    class="text-muted font-weight-bold d-block">Comunicacion
                                                                    con el Maestro</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="#"
                                                                    ...
                                                                    de Contenidos</a>
                                                                <span
                                                                    class="text-muted font-weight-bold d-block">Contenidos
                                                                    de avance</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
