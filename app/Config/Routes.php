...
$routes->get('admin/update_section', 'Admin::update_section');
$routes->get('admin/section_students/(:any)', 'Admin::section_students/$1');
$routes->get('admin/list_students', 'Admin::list_students');
...
$routes->get('admin/generate_centralizer/(:any)', 'Admin::generate_centralizer/$1');
...
$routes->post('secretary/assistance_by_date', 'Secretary::assistance_by_date');
$routes->get('secretary/assistance_center', 'Secretary::assistance_center');
...
$routes->get('secretary/suspensions', 'Secretary::suspensions');
$routes->get('secretary/suspension_get/(:num)', 'Secretary::suspension_get/$1');
$routes->get('secretary/suspension_get_students', 'Secretary::suspension_get_students');
$routes->get('secretary/suspension_get_periods', 'Secretary::suspension_get_periods');
$routes->get('secretary/suspension_get_periods_section/(:num)', 'Secretary::suspension_get_periods_section/$1');
...
$routes->get('teacher/recover_score/(:any)', 'Teacher::recover_score/$1');
...
$routes->get('teacher/adviser_search/(:any)', 'Teacher::adviser_search/$1');
$routes->get('teacher/adviser_summary/(:num)', 'Teacher::adviser_summary/$1');
